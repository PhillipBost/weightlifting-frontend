...
export function UpcomingMeetsContent({ initialMeets = [] }: { initialMeets?: Meet[] }) {
    ...
    const [filters, setFilters] = useState<FilterState>({
        ...
        selectedCountries: [],
        selectedLevels: [],
        startDate: new Date().toLocaleDateString('en-CA'), // Formats to YYYY-MM-DD in local time
        endDate: ''
    });
    ...
    // Sorting State
    const [sortConfig, setSortConfig] = useState<{ key: keyof Meet; direction: 'asc' | 'desc' }>({ key: 'date', direction: 'asc' });
    ...
    const filteredMeets = useMemo(() => {
        return meets.filter(meet => {
            ...
            if (filters.endDate) {
                const meetDate = new Date(`${meet.date}T12:00:00`).getTime();
                const endDate = new Date(`${filters.endDate}T12:00:00`).getTime();
            ...
            if (filters.selectedYears.length > 0) {
                const meetYear = new Date(`${meet.date}T12:00:00`).getFullYear();
            ...
            <div className={`card-primary transition-opacity duration-200 ${loading ? 'pointer-events-none opacity-60' : ''}`}>
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-app-primary">Upcoming Meets</h1>
                            <p className="text-sm text-app-secondary mt-1">
                                Discover national and international upcoming meets filtered by federation, year, location, and more.
                            </p>
                ...
                <div className="p-6">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-20">
                            ...
                            <p className="text-sm text-app-tertiary">Loading upcoming meets...</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-20 text-app-tertiary">
                            ...
                            <p className="font-medium">No upcoming meets found</p>
